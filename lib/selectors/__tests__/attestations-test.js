...
it('returns attestations for issuer and type', () => {
  expect(toJs(attestationsForIssuerAndType(withIdentity, 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', 'nationalId'))).toEqual([{'claim': {'nationalId': 'xxx0xxxx0xxx'}, 'iss': 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', 'token': '0014.TOKEN'}])
  expect(toJs(attestationsForIssuerAndType(withIdentity, 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', 'name'))).toEqual([{'claim': {'name': 'Alice'}, 'exp': 2, 'iss': 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', 'token': '0015.TOKEN'}])
  ...
  expect(toJs(attestationsForIssuerAndType(withMultipleIdentities, 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', 'phone'))).toEqual([{'claim': {'phone': '555-555-5555'}, 'iss': 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', 'token': '0013.TOKEN'}])
})
