...
describe('requestedOwnClaims', () => {
  it('returns self attested', () => {
    ...
    expect(toJs(requestedOwnClaims(withIdentity, ['name']))).toEqual({name: 'Alice'})
    expect(toJs(requestedOwnClaims(withIdentity, ['name', 'nationalId', 'nonexisting']))).toEqual({name: 'Alice'})
  
    expect(toJs(requestedOwnClaims(withMultipleIdentities, []))).toMatchSnapshot()
    expect(toJs(requestedOwnClaims(withMultipleIdentities, ['name']))).toMatchSnapshot()
    expect(toJs(requestedOwnClaims(withMultipleIdentities, ['name', 'nationalId', 'nonexisting']))).toMatchSnapshot()
  })
})

describe('missingClaims', () => {
  it('handles missing claims specs', () => {
    expect(missingClaims(withIdentity, [{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01'}]}])).toEqual([])
    expect(missingClaims(withIdentity, [{type: 'cityId', iss: [{did: 'did:web:city.claims', url: 'https://city.claims'}], essential: true, reason: 'We need this'}, {type: 'name'}])).toEqual([{type: 'cityId', iss: [{did: 'did:web:city.claims', url: 'https://city.claims'}], essential: true, reason: 'We need this'}])
    expect(missingClaims(withIdentity, [{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc0a'}]}])).toEqual([{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc0a'}]}])
    expect(missingClaims(withIdentity, [{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc0b'}]}, 'nationalId'])).toEqual([{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc0b'}]}])
  })
})
...
describe('verifiedClaimsTokens', () => {
  ...
  it('handles claims specs', () => {
    ...
    expect(toJs(verifiedClaimsTokens(withIdentity, [{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01'}]}]))).toEqual(['0015.TOKEN'])
    ...
    expect(toJs(verifiedClaimsTokens(withIdentity, [{type: 'name', iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01'}]}, 'nationalId']))).toEqual(['0015.TOKEN', '0014.TOKEN'])
  })
})
