...
import { toJs, hashMap, isEmpty, count, selectKeys, vector, assoc, set, get, getIn, vals, map, reduce, reduceKV, inc, updateIn, sortedMap, first, groupBy, keys, dissoc, filter, reverse, concat, conj } from 'mori'
import { currentIdentity, ownClaims, currentDID, normalizeDID } from './identities'

const externalIdentities = state => get(state.uport, 'external')
