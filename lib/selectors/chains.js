...
export const networkSettingsForAddressMap = createSelector(
  ...
  (identity, identities) => {
    const main = selectKeys(identity, ['address', 'hexaddress', 'deviceAddress', 'controllerAddress', 'txRelayAddress', 'recoveryAddress', 'recoveryType', 'signerType', 'network', 'nonce', 'metaNonce', 'fuelToken', 'fuel', 'balance', 'parent', 'rpcUrl', 'registry', 'faucetUrl', 'relayUrl'])
    return main
  }
)
