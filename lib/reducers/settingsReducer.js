...
//
import { SET_CHANNEL, START_SWITCHING_DATABACKUP, SET_DATABACKUP, SET_OPT_OUT, SET_DATA_CUSTOM_URL } from 'uPortMobile/lib/constants/SettingsActionTypes'
...
function settingsReducer (state = initialState, action) {
  switch (action.type) {
    ...
    case SET_DATA_CUSTOM_URL:
      return { ...state, dataCustomUrlBackup: action.customUrl}
    case SET_DATABACKUP:
