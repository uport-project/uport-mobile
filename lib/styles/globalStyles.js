...
export const widthRatio = width => windowWidth * (width / 375)
export const heightRatio = height => windowHeight * (height / 667)

const brandColor = '#143a8d'
...
export const colors = {
  ...
  red: 'rgba(80, 202, 124, 1)',
  // red changed to green #50ca7c, kept name as red so reference works
  purple: brandColor,
  // changed purple brand color to blue #143a8d
  lightPurple: `rgba(4,51,159,1)`,
  // light purple was actually darker than brandcolor purple; placed darker blue than brand here
  translucentPurple: 'rgba(5, 47, 205, 0.3)',
  //translucent blue instead
