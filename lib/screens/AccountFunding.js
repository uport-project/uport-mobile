    ...
    const message =
      this.props.network === 'mainnet'
        ...
        : `My address on the ${this.props.network} network is ${
          ...
          }. WARNING! Do not send real ETH here! You will loose it!`
    Share.share({
      message,
    ...
    return (
      <View>
        <View>
          ...
          <Text style={{ fontSize: metrics.font.size.regular, textAlign: 'center' }}>
        ...
        >
          ...
          <Ionicon name={'ios-share'} size={32} />
        </TouchableOpacity>

        {this.props.network !== 'mainnet' ? (
          <View style={{ marginTop: 30 }}>
            <Text style={{ fontSize: metrics.font.size.medium, textAlign: 'center' }}>Request test Ether for free</Text>
