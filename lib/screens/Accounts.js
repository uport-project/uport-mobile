        ...
        return (
            ...
            <View style={styles.cardInner}>
                <View style={[styles.header, {flexDirection: 'row'}]}>
                    <View>
                        <Avatar size={60} source={item.issuer || {avatar: require('uPortMobile/assets/images/ethereum-white-icon.png')}} />
                    </View>
                    <View style={{marginLeft: 10}}>
                        <Text style={styles.titleText}>{ claimCardHeader }</Text>
                        <Text style={styles.subtitleText}>{item.issuer && item.issuer.name ? item.issuer.name : `Unknown issuer`}</Text>
                    </View>
                </View>
            </View>
            </TouchableOpacity>
                        ...
                        :   <ScrollView contentContainerStyle={styles.scrollContent}>
                                <View style={styles.intro}>
                                    ...
                                    <Text style={styles.introtext}>
                                        Try out the uPort demo to get your first credential.
                                    </Text>
