            ...
            >
                <View style={styles.cardInner}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitleText}>{ item.balance && `${wei2eth(item.balance.ethBalance)} ETH | `}{ networkName } network</Text>
                    </View>
                    <SharedElementTransition
                        style={{flex: 1}}
                        sharedElementId={item.address}>
                        <View style={styles.banner}>
                            <Avatar size={150} source={accountProfile || {avatar: require('uPortMobile/assets/images/ethereum-white-icon.png')}} />
                        </View>
                    </SharedElementTransition>
                </View>
            </TouchableOpacity>
        ...
        return (
            <TouchableOpacity style={[styles.card, styles.demoCard]} onPress={() => this.openDemoUrl('demo.uport.me')}>
                <View style={styles.cardInner}>
                    ...
                    <View style={[styles.banner]}>
                        <Feather name='external-link' size={100} color={'#426996'} />
                    </View>
                </View>
            </TouchableOpacity>
        )
