...
import { Platform, FlatList, ScrollView, TouchableHighlight, TouchableOpacity, StyleSheet, View, SafeAreaView, Dimensions, Text, TextInput, Share} from 'react-native'
        ...
        return (
            <SafeAreaView style={{flex: 1}}>
                <ScrollView
                    ...
                    <View style={{backgroundColor: colors.brand, alignItems: 'center', justifyContent: 'center'}}>
                        {
                    ...
                    <View style={{backgroundColor: '#EAEAEA', flexDirection: 'row', flex: 1}}>
                        <TouchableOpacity onPress={() => this.props.navigator.switchToTab({tabIndex: 0})} style={{alignItems: 'center', flex: 1, paddingVertical: 15}}>
                        ...
                        <TouchableOpacity onPress={() => this.openShareModal()} style={{justifyContent: 'center', alignItems: 'center', flex: 1, paddingVertical: 15, flexDirection: 'row'}}>
                            <FeatherIcon size={30} name="share" color={colors.brand}/>
                            <Text style={{fontSize: 20, paddingLeft: 10, color: colors.brand}}>Share</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <View style={styles.infoRowContainer}>
                    <View style={styles.infoRow}>
                        <View style={{flex: 1}}>
                            ...
                            <Text style={[styles.infoContent, {color: colors.grey74}]}>{ accountProfile ? accountProfile.name : 'Ethereum Account'}</Text>
