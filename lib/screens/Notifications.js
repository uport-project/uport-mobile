...
import InfoNotification from 'uPortMobile/lib/components/Notifications/Types/InfoNotification'
import SignTypedDataNotification from 'uPortMobile/lib/components/Notifications/Types/SignTypedDataNotification'
  ...
  renderNoNotifications() {
    return (
      <View style={styles.emptyStateContainer}>
        <FeatherIcon size={100} color={colors.white226} name='bell' />
...
const mapStateToProps = state => ({
  ...
  requested: activity => activity.requested ? requestedClaims(state, activity.requested) : [],
})
