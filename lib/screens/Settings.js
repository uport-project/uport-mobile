...
import { Screen, ListItem, Section } from '@kancha'
...
const Chevron = () => <Icon name={Platform.OS === 'ios' ? 'ios-arrow-forward' : 'md-arrow-forward'} color={colors.grey216} style={{marginLeft: 16}} size={20} />
...
class Settings extends React.Component {
    ...
    render() {
        return (
            <Screen>
                <Section>
                    <ListItem infoNoteRight={`${this.props.version} (${this.props.channel})`}>App Version</ListItem>
                    <ListItem onPress={() => this.goToScreen('advanced.uport')}>uPort ID</ListItem>
                    <ListItem onPress={() => this.goToScreen('advanced.uport')} last>Support</ListItem>
                </Section>
                <Section>
                    <ListItem>Account Back Up</ListItem>
                    <ListItem>Account Recovery</ListItem>
                    <ListItem last>Support</ListItem>
                </Section>
                <Section>
                    <ListItem>Device</ListItem>
                    <ListItem>Identity Hub Status</ListItem>
                    <ListItem last>System Messages</ListItem>
                </Section>
                <Section>
