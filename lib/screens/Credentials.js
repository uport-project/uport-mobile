...
class Accounts extends React.Component {
  ...
  renderTryDemoCard() {
    return (
      <TouchableOpacity style={[styles.card, styles.demoCard]} onPress={() => this.openDemoUrl('uportlandia.uport.me')}>
        <View style={styles.cardInner}>
        ...
        {this.props.verifications.length > 0 ? (
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            <View style={styles.intro}>
              ...
              <Text style={styles.introtext}>Try out Haven ID and receive your first credential.</Text>
