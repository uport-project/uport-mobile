...
You expressly understand and agree that your use of the Service is at your sole risk. The Service (including the Service and the Content) is provided on an "AS IS" and "as available" basis, without warranties of any kind, either express or implied, including, without limitation, implied warranties of merchantability, fitness for a particular purpose or non-infringement. You acknowledge that uPort has no control over, and no duty to take any action regarding: which users gain access to or use the Service; what affects the Content may have on you; how you may interpret or use the Content; or what actions you may take as a result of having been exposed to the Content. You release uPort from all liability for you having acquired or not acquired Content through the Service. uPort makes no representations concerning any Content contained in or accessed through the Service, and uPort will not be responsible or liable for the accuracy, copyright compliance, legality or decency of material contained in or accessed through the Service.
...
You acknowledge and understand that Cryptography is a progressing field. Advances in code cracking or technical advances such as the development of quantum computers may present risks to cryptographic systems and Services or Content, which could result in the theft or loss of your cryptographic tokens or property. To the extent possible, uPort intends to update the code underlying the Services to account for any advances in cryptography and to incorporate additional security measures, but does not guarantee or otherwise represent full security of the system. By using the Service or accessing Content, you acknowledge these inherent risks.

5.4. Platform Security
You acknowledge that Ethereum applications are code subject to flaws and acknowledge that you are solely responsible for evaluating any available code provided by the Services or Content and the trustworthiness of any third-party websites, products, smart-contracts, or Content you access or use through the Service. You further expressly acknowledge and represent that Ethereum applications can be written maliciously or negligently, that uPort cannot be held liable for your interaction with such applications and that such applications may cause loss of property or identity. Information relayed to IPFS and stored in contracts is currently unencrypted. Malicious actors may potentially access information such as name, photo, description, and members of your recovery network, presenting both disclosure and potential security risks. These warnings and others later provided by uPort in no way evidence or represent an on-going duty to alert you to all of the potential risks of utilizing the Service or Content.

5.5. Risk of Regulatory Actions in One or More Jurisdictions
You acknowledge that as an emerging technology, uPort or Ethereum could be impacted by one or more regulatory inquiries or regulatory actions, which could impede or limit the ability of uPort to continue to develop, or which could impede or limit your ability to access or use the Service or Ethereum blockchain.
...
You acknowledge that uPort did not manufacture your device.  The security of the security enclave of your device is dependent on the manufacturer of the device.  If you have reason to believe the security of your device’s security enclave has been compromised, you agree to stop the use of uPort and to seek assistance directly with the device’s manufacturer.  You acknowledge the risk that if the security or integrity of your device’s security enclave is compromise, the security of your private key may be at risk.

uPort does not own or operate the third-party servers used to store ID Data.  The security and safety of the data is dependent on the owner and operator of the third-party servers.  You acknowledge that in the event the security or integrity of the third-party servers are compromised, your ID Data may be completely or partially damaged and/or lost.    

6. Attestations on uPort and the uPort Signing Service
...
export const termsAndConditions3 =
...
uPort responds to notices of alleged infringement. 

If you have a good faith belief that your work has been copied in a way that constitutes copyright infringement on or through the  Services, please send a notice of copyright infringement (“Notice”) to uPort via email to notices@consensys.net with attention to uPort Copyright. Please note that the uPort Privacy Policy does not protect information provided in a Notice. 
...
You have the right to opt-out and not be bound by the arbitration and class action waiver provisions set forth above by sending written notice of your decision to opt-out to the following address: uPort ℅ ConsenSys, 49 Bogart Street, Brooklyn NY 11206 and via email at notices@consensys.net. The notice must be sent within 30 days of September 6, 2016 or your first use of the Service, whichever is later, otherwise you shall be bound to arbitrate disputes in accordance with the terms of those paragraphs. If you opt-out of these arbitration provisions, uPort also will not be bound by them.

14.7. Changes to this Section
uPort will provide 60-days’ notice of any changes to this section. Changes will become effective on the 60th day and will apply prospectively only to any claims arising after the 60th day. For any dispute not subject to arbitration you and uPort agree to submit to the personal and exclusive jurisdiction of and venue in the federal and state courts located in New York, New York. You further agree to accept service of process by mail, and hereby waive any and all jurisdictional and venue defenses otherwise available. The Terms and the relationship between you and uPort shall be governed by the laws of the State of New York without regard to conflict of law provisions.

15. General Information

15.1. Entire Agreement
These Terms (and any additional terms, rules and conditions of participation that uPort may post on the Service) constitute the entire agreement between you and uPort with respect to the Service and supersedes any prior agreements, oral or written, between you and uPort. In the event of a conflict between these Terms and the additional terms, rules and conditions of participation, the latter will prevail over the Terms to the extent of the conflict.

15.2. Waiver and Severability of Terms
The failure of uPort to exercise or enforce any right or provision of the Terms shall not constitute a waiver of such right or provision. If any provision of the Terms is found by an arbitrator or court of competent jurisdiction to be invalid, the parties nevertheless agree that the arbitrator or court should endeavor to give effect to the parties' intentions as reflected in the provision, and the other provisions of the Terms remain in full force and effect.
...
//   <View style={[{flex: 1}, props.defaultPadding && {paddingTop: 50}]}>
//     <Text subTitle>
