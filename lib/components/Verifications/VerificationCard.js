...
export class VerificationCard extends React.Component {
  ...
  static navigatorButtons = {
    rightButtons: [
      {
        icon: Platform.OS === 'ios' ? require('uPortMobile/images/more_ios.png'): require('uPortMobile/images/more_android.png'),
    ...
    return (
      <View style={styles.cardContainer}>
        <View style={styles.fromContainer}>
          <Text style={styles.fromIssuer}>from: <Text style={{fontWeight: '600'}}>{(this.props.issuer !== null ? this.props.issuer.name : this.props.verification.iss.slice(0,10))}</Text></Text>
