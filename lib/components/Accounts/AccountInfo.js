...
export class AccountInfo extends React.Component {
  constructor (props) {
    ...
    this.showFundingScreen = this.showFundingScreen.bind(this)
  }
  componentDidMount () {
  ...
  render () {
    return (
      <ScrollView
        ...
        <AccountTile accountProfile={this.props.accountProfile} balance={this.props.balance} network={this.props.network} usdBalance={this.props.usdBalance} tileButton={this.showFundingScreen} buttonIcon={'plus-square'} />
      </ScrollView>
    )
  }
}
