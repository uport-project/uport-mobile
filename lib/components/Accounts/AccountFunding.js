  ...
  renderWarningMessage() {
    return (
      <View style={styles.warningMessageContainer}>
        <EvilIcon name='alert-triangle' size={metrics.font.size.large} color={colors.red} />
    ...
    return (
      <View>
        ...
        <View style={styles.addressTextView} onPress={() => this.copyHandler()}>
          ...
          <Text style={{textAlign: 'center', fontSize: metrics.font.size.large }}>Tap address to copy. Press and hold to share. </Text>
        </View>
