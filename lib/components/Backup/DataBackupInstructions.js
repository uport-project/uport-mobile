        ...
        <KeyboardAwareScrollView overScrollMode='always'>
          <Text p>
            {!this.props.dataBackup
              ? 'Your account is not currently backed up. If you need to recover your account, you will be able to recover your uPort ID and main address, but you will not be able to recover claims, credentials, or app-specific accounts.'
              : "Your account is currently backed up. This means in the event of a recovery you'll be able to recover your uPort ID, application accounts, and associated claims and data. By turning backup off, you will delete the encrypted copy of your data on our backup server and will be able to recover only your uPort ID, but not application accounts, claims or data."}
          </Text>
          <Checkbox
