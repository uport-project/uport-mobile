...
export class SeedBackupInstructions extends React.Component {
  ...
  pushNextScreen() {
    Navigation.push(this.props.componentId, {
      component: {
        name: SCREENS.BACKUP.CreateSeedPhrase,
      },
    })
  }
    ...
    return (
      <View style={styles.container}>
        <KeyboardAwareScrollView overScrollMode='always'>
          <Text p>
            Your account is currently at risk. Please back up your seed phrase to ensure that you can recover your
            account in the event of a lost or compromised device.
          </Text>
          <Checkbox
        ...
        <OnboardingButton disabled={!this.state.agree} onPress={this.handleOnContinuePress}>
          {'Setup Seed Recovery'}
        </OnboardingButton>
      </View>
    )
