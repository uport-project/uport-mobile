    ...
    return (
      <View style={styles.container}>
        <KeyboardAwareScrollView overScrollMode='always'>
          <Text p>
            This is your personal Recovery Phrase. This phrase protects your identity, so keep it safe and private. We
            recommend physically writing it down and storing copies in different locations.
          </Text>
        ...
        <OnboardingButton
          onPress={() =>
            Navigation.push(this.props.componentId, {
              component: {
                name: SCREENS.BACKUP.CreateSeedPhraseConfirm,
                options: {
                  topBar: {
                    visible: false,
                  },
