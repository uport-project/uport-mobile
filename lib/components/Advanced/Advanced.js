  ...
  render() {
    return (
      <Menu>
        ...
        {this.props.designSystemFlag && (
          <MenuItem title='Design System' navigator={this.props.navigator} destination='design.main' />
        )}
        ...
        {this.props.hasHDWallet && (
          <MenuItem title='Identity Hub Status' navigator={this.props.navigator} destination='advanced.hub' />
        )}
