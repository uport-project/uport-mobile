...
const Advanced = (props) => (
  <NavigatableScreen navigator={props.navigator}>
    <Menu>
      ...
      <MenuItem title='GqlPlayground' navigator={props.navigator} destination='GqlPlayground'/>
      <MenuItem title='Create Support Summary' onPress={props.shareStateDump} last />
    </Menu>
  </NavigatableScreen>
)
