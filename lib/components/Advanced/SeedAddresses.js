...
export const SeedAddresses = (props) => (
  <NavigatableScreen navigator={props.navigator}>
    ...
    <Menu>
      ...
      <MenuItem title='hdroot' value={props.root} />
    </Menu>
    {props.debugFlag && props.device !== props.root ? <DangerButton onPress={() => props.resetAddress(props.root)}>Reset hdRoot (RH Bug)!!!</DangerButton> : null}
