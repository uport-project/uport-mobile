...
export const Device = (props) => (
  <NavigatableScreen navigator={props.navigator}>
    <Menu>
      <MenuItem title='Device Address' value={abbr(props.deviceAddress)} embed={`${props.explorerUrl}/address/${props.deviceAddress}`} />
      <MenuItem title='Device Gas' value={wei2eth(props.fuel || 0) + ' ETH'} working={props.workingFuel} />
      <MenuItem title='Device Nonce' value={props.nonce || 0} working={props.workingNonce} />
      <MenuItem title='Signer Type' value={props.signerType || 0} />
      <MenuItem title='TX Relay Address' value={props.txRelayAddress || 0}  />
      <MenuItem title='Controller Address' value={props.controllerAddress || 0}  last />
    </Menu>
  </NavigatableScreen>
)
