...
import DeviceConnect, { Device } from '../Device'
import FakeNavigator from '../../testHelpers/FakeNavigator'
import renderer from 'react-test-renderer'
describe('Advanced - Device', () => {
  it('renders fuel of 0 and nonce of 0', () => {
    const tree = renderer.create(
      <Device navigator={new FakeNavigator()}
        deviceAddress='0x9df0e9759b17f34e9123adbe6d3f25d54b72ad6a'
        fuel={0}
        nonce={0}
      />
    ).toJSON()
  ...
  it('renders fuel of 11210000000000100111', () => {
    const tree = renderer.create(
      <Device navigator={new FakeNavigator()}
        deviceAddress='0x9df0e9759b17f34e9123adbe6d3f25d54b72ad6a'
        fuel={11210000000000100111}
        nonce={3}
      />
    ).toJSON()
    expect(tree).toMatchSnapshot()
