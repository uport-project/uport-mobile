...
const styles = StyleSheet.create({
  container: {
    ...
    overflow: 'visible',
    paddingRight: metrics.spacing.horizontal.extraLarge,
    paddingTop: metrics.spacing.vertical.extraLarge,
    paddingBottom: metrics.spacing.vertical.extraLarge,
    paddingLeft: metrics.spacing.horizontal.extraLarge,
  ...
  return (
    <View elevation={10} style={styles.container}>
      ...
      <View style={styles.tileBottomHalf}>
        <View>
          <Text style={{fontSize: metrics.font.size.medium}}>Ethereum Account</Text>
