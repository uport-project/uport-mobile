...
import { View, Platform, KeyboardAvoidingView, TouchableOpacity, ScrollView, TouchableHighlight } from 'react-native'
      ...
      <View style={styles.container}>
        ...
        <KeyboardAvoidingView
          ...
          <View style={styles.opaqueContainer}>
            ...
            { this.props.existingIdentity
            ? <View>
              <Text p>If you have lost your seed phrase you can create a new Identity instead. We will save as much of your data as possible, but you will not be able to sign anything on behalf of your old identity.</Text>
              <TouchableHighlight onPress={this.props.createNewIdentity}>
                <Text p style={{color: 'red'}}>Create new Identity</Text>
              </TouchableHighlight>
            </View>
            : null
            }
