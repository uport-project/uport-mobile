...
import { View, Platform, KeyboardAvoidingView, TouchableOpacity, ScrollView, Keyboard } from 'react-native'
  ...
  render() {
    ...
    return (
      <View style={[styles.container]}>
        ...
        <KeyboardAvoidingView behavior={'padding'} enabled={true} keyboardVerticalOffset={60}>
          <OnboardingButton
