...
import { Text, TouchableOpacity, View, SafeAreaView, VirtualizedList, StyleSheet, DeviceInfo, Platform } from 'react-native'
...
//       case 'disclosure':
//         return (<DisclosureCard {...props} />)
//       // case 'recover':
//       //   return (<RecoveryCard {...props} />)
//       case 'connect':
//         return (<ConnectionCard {...props} />)
//       case 'attestation':
//         return (<AttestationCard {...props} />)
//       // case 'net':
//       //   return (<NetworkCard {...props} />)
//     }
//   }
//   return (<View />)
// }
...
export class Request extends Component {
  ...
  onNavigatorEvent(event) { // this is the onPress handler for the two buttons together
    if (event.type == 'NavBarButtonPress') { // this is the event type for button presses
      ...
      //   this.props.authorizeRequest(this.props.requestId)
      // }
    }
  }
  ...
  pickCard () {
    switch (this.props.requestType) {
      case 'sign':
        return (<TransactionCard navigator={this.props.navigator} />)
      case 'disclosure':
        return (<DisclosureCard navigator={this.props.navigator} />)
      case 'connect':
        return (<ConnectionCard navigator={this.props.navigator} />)
      case 'attestation':
        return (<VerificationCard navigator={this.props.navigator} />)
      case 'net':
        return (<NetworkCard navigator={this.props.navigator} />)
      case 'property':
        return (<PropertyCard navigator={this.props.navigator} />)
      case 'verificationSign':
        return (<VerificationSignCard navigator={this.props.navigator}/>)
      case 'eip712Sign':
        return (<Eip712SignCard navigator={this.props.navigator}/>)
      case 'personalSign':
        return (<PersonalSignCard navigator={this.props.navigator}/>)
      }
  }
  ...
  render() {
    ...
    <View style={{flex: 1}}>
      ...
      <View style={styles.card}>
        <View style={[styles.titleBar, this.props.requestType === 'attestation' ? {marginBottom: 0, paddingBottom: 10} : {}]}>
          <Text style={styles.cardTitle}>
            {cardTitle[this.props.requestType]}
          </Text>
          <TouchableOpacity 
