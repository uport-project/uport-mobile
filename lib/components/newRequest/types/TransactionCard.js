      ...
      return (
        <View>
          <View style={{backgroundColor: '#F6F5FE', borderTopLeftRadius: 12, borderTopRightRadius: 12}}>
            ...
            <AccountTileSmall accountProfile={this.props.client} balance={this.props.balance} usdBalance={this.props.usdBalance} onRefresh={() => this.props.refreshBalance(this.props.address)} />
...
const mapStateToProps = (state) => {
  ...
  const network = decodedMnid ? (networks[decodedMnid.network] || {name: decodedMnid.network}).name : currentNetwork(state)
