...
import { requestedClaims, requestedVerifiableClaims, missingClaims } from 'uPortMobile/lib/selectors/attestations'
          ...
          ? <View style={styles.credentialsListContainer}>
            ...
            {props.verified.length > 0 || props.missing.length > 0 ?
              <View>
                ...
                <RequestItemList>
                  {props.verified.map((vc, i) => <RequestItem key={vc.iss + '-' + i} type={vc.claimType} value={vc.claim[vc.claimType]} vc={vc} />)}
