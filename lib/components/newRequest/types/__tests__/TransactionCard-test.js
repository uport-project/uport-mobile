...
import ConnectedCard, { TransactionCard } from '../transaction/TransactionCard'
...
describe('TransactionCard', () => {
  ...
  it('calls linking open from a Button press', () => {
    ...
    this.wrapper = global.shallow(
      <TransactionCard request={txRequest} cancelRequest={cancel} authorizeRequest={authorize} validDestination />,
    )
    this.wrapper
      .find(Button)
      .props()
