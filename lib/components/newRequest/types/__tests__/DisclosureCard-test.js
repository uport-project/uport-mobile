...
import ConnectedCard, { DisclosureCard } from '../DisclosureCard.js'
...
const missingClaimWithMultipleIssuer = {
  type: 'email',
  iss: [{did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc01', url: 'https://uport.claims'}, {did: 'did:ethr:0x1bc5cbf71b068642fc5e89c5e3d0bdb3e366bc0a', url: 'https://serto.claims'}],
  reason: 'This is important so we can send you emails',
  essential: true
}
