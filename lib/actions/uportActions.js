...
//
import { CREATE_ACCOUNT, CREATE_IDENTITY, ADD_IDENTITY, STORE_SUB_ACCOUNT, STORE_IDENTITY, UPDATE_IDENTITY, SWITCH_IDENTITY, ADD_OWN_CLAIMS, REMOVE_OWN_CLAIM, STORE_EXTERNAL_UPORT,
...
export function updateIdentity (address, data) {
  return {
