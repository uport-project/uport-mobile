...
export function* startApplication() {
  try {
    ...
    if (address) {
      ...
      //   verified: [
      //     {iss: 'did:ethr:0xc0fb1c7099b2599d3450641d8b141d99836fe593', type: 'Uportlandia City ID', essential: true, url: 'https://uportlandia.uport.me', reason: 'We can only offer services to uPortlandia citizens'},
      //     {iss: 'did:ethr:0xc0fb1c7099b2599d3450641d8b141d99836fe593', type: 'email', essential: true, url: 'https://uportlandia.uport.me', reason: 'We need to be able to communicate with you'}]
      // })
