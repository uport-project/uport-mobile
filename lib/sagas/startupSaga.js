...
import { startApp } from '../navigators/navigation'
  ...
  try {
    ...
    if (address) {
      ...
      // const token = yield createToken(address, {
        ...
        // from: '0x668b6e5ba9eed916706b1a80cbd131dcf9c79191',
        // type: 'ethtx',
        // value: '0x11111111111',
        // net: '0x4', // 0x1 for mainnet, 0x4 for rinkeby, 0x2a for kovan
        // act: 'keypair', // or segregated (not for mainnet)
        // to: '2oj62ZVbgQFHUitiUGrMrCrRaMM2kxm18dK',
        // // Next exampple breaks estimateGas on rinkebby so can be used to test that
        // // fn: `groupBet(bytes32 0x4861636b61746f6e313033305f31303452, string "test", address 0xe47d68c6f991d23867f0c2a98d074ae77d7941bf, uint 1, uint 2, uint 3)`
        // fn: `joinChallenge(bytes32 0x4861636b61746f6e313033305f31303450, bool true)`
      ...
      //   callback: 'https://testapp.uport.me',
      //   networkId: '0x4', // 0x1 for mainnet, 0x4 for rinkeby, 0x2a for kovan
      ...
      //     'address'
      //   ],
      //   verified: ['Uportlandia City ID', 'email'],
      //   claims: {
      //     verifiable: {
      //       'Uportlandia City ID': {
      //         // iss: [
      //         //   {
      //         //     did: 'did:ethr:0xc0fb1c7099b2599d3450641d8b141d99836fe593',
      //         //     url: 'https://uportlandia.uport.me'
      //         //   }
      //         // ],
      //         essential: false,
      //         reason: 'We can only offer services to uPortlandia citizens'
      //       },
      //       email: {
      //         iss: [
      //           {
      ...
      //           {
      //             did: 'did:ethr:0xc0fb1c7099b2599d3450641d8b141d99836fe593',
      //             url: 'https://serto.claims'
      //           }
      //         ],
      //         essential: false,
      //         reason: 'We need to be able to communicate with you'
      //       }
      //     }
      //   }
      // })
      // yield put(handleURL(`me.uport:req/${token}`))
      ...
      yield call(startApp, 'ONBOARDING')
    }
  } catch (e) {
    console.log('---------------------------------------------------')
