...
describe('createToken', () => {
  it('sign jwt', () => {
    return expectSaga(createToken, address, {claims: {name: 'Bob'}}, { prompt: 'sign attestation', issuer: address })
      ...
      .returns('eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ.eyJpYXQiOjE0ODUzMjExMzMsImNsYWltcyI6eyJuYW1lIjoiQm9iIn0sImlzcyI6ImRpZDp1cG9ydDozNHdqc3h3dmR1YW5vN05GQzh1ak5KbkZqYmFjZ1llV0E4bSJ9.HjgqqYUKAG2l7cw0gmJZNZ3jxpRSji21JA7H2TTteT62dR39poR3zFOuGdAQD0-Su7ehUPZ25lJ2wKotgbtp7Q')
      .run()
