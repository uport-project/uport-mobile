  ...
  describe('using did', () => {
    ...
    it('fetches and returns simple while translating images', () => {
      return expectSaga(fetchPublicUport, did)
        ...
        .call(resolve, did)
        .returns({name: 'Bob Smith', avatar: {uri: 'https://cloudflare-ipfs.com/me.jpg'}, banner: {uri: 'https://cloudflare-ipfs.com/banner.jpg'}})
        .run()
    })
...
describe('savePublicUport', () => {
  ...
  it('fresh identity', () => {
    return expectSaga(savePublicUport, {address})
      ...
      .put(saveMessage('persona', 'Updating DID Document in uPort Registry'))
  ...
  it('unchanged identity', () => {
    return expectSaga(savePublicUport, {address})
      ...
      .put(startWorking('persona'))
      .not.put(saveMessage('persona', 'Updating DID Document in uPort Registry'))
      .put(completeProcess('persona'))
      .returns(true)
      .run()
  })
...
//       ])
//       .call(addImage, image)
//       .put(addClaims(address, {avatar: {uri: 'https://cloudflare-ipfs.com/ipfs/QmdNm7VZTNnux2LS6vMJXLZ5BGb3rPJV9mF5jA72uq9y8o'}}))
//       .run()
//   })
//
...
//       ])
//       .call(addImage, image)
//       .not.put(addClaims(address, {avatar: {uri: 'https://cloudflare-ipfs.com/ipfs/QmdNm7VZTNnux2LS6vMJXLZ5BGb3rPJV9mF5jA72uq9y8o'}}))
//       .run()
//   })
//
...
describe('addImageToIpfsOnboarding', () => {
  ...
  it('stores image and saves it to own claims', () => {
    return expectSaga(addImageToIpfsOnboarding, {avatarObj: {avatar: image}})
      ...
      .call(addImage, image)
      .put(addData({avatar: {uri: 'https://cloudflare-ipfs.com/ipfs/QmdNm7VZTNnux2LS6vMJXLZ5BGb3rPJV9mF5jA72uq9y8o'}}))
      .run()
  })
  ...
  it('does not store data if saving fails', () => {
    return expectSaga(addImageToIpfsOnboarding, {avatarObj: {avatar: image}})
      ...
      .call(addImage, image)
      .not.put(addData({avatar: {uri: 'https://cloudflare-ipfs.com/ipfs/QmdNm7VZTNnux2LS6vMJXLZ5BGb3rPJV9mF5jA72uq9y8o'}}))
      .run()
  })
