...
describe('canSignFor()', () => {
  ...
  describe('non HD account', () => {
    ...
    describe('HD account', () => {
      describe('is stored in keychain using hexaddress', () => {
        it('returns true', () => {
          return expectSaga(canSignFor, address)
            .provide([
              [select(networkSettingsForAddress, address), {hexaddress: deviceAddress, hdindex: 1}],
      ...
      describe('is stored in keychain using deviceAddress', () => {
        it('returns true', () => {
          return expectSaga(canSignFor, address)
            .provide([
