      ...
      it('is successful', () => {
        return expectSaga(recoverySaga)
          .provide([
            ...
            [call(NativeModules.NativeHDSignerModule.importSeed, seed, DEFAULT_LEVEL), {address: root}],
            [call(importSeed, seed), kp],
            [call(lookupAccount, {deviceAddress})],
            [call(alert, 'Recovery Successful!!!', 'Your Identity was successfully recovered')],
            [call(startMain)]
          ])
          .put(startWorking('recovery'))
          .call(NativeModules.NativeHDSignerModule.importSeed, seed, DEFAULT_LEVEL)
  ...
  describe('errors', () => {
    it('invalid seed fails', () => {
      return expectSaga(recoverySaga)
        .provide([
          [select(securityLevel), DEFAULT_LEVEL],
          [call(NativeModules.NativeHDSignerModule.importSeed, seed, DEFAULT_LEVEL), undefined]
        ])
        .put(startWorking('recovery'))
        .call(NativeModules.NativeHDSignerModule.importSeed, seed, DEFAULT_LEVEL)
