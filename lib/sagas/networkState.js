...
// var requests = _.queue()
// // Executes given function f if we are connected to the internet
// // If not then queue the function for execution once we connect again
// export function* whenConnected (f) {
//   const isConnected = yield connected()
//   if (isConnected) {
//     return yield call(f)
//   } else {
//     console.log('not connected. Queueing')
//     requests = _.conj(requests, () => )
//   }
// }
