...
import { START_SWITCHING_DATABACKUP, SET_DATA_CUSTOM_URL } from 'uPortMobile/lib/constants/SettingsActionTypes'
...
import { dataBackup, dataCustomUrlBackup } from 'uPortMobile/lib/selectors/settings'
...
export function * sendEvent (event) {
  try {
    ...
    // Custom URL //
    const customUrl = yield select(dataCustomUrlBackup)
    const fetchCallBackupUrl = (customUrl) ? customUrl : backupUrl
    //console.log("FetchCallBackupUrl: ", fetchCallBackupUrl)
    //console.log("customUrl: ", customUrl)
    //console.log("backupUrl: ", backupUrl)
    //console.log(token)

    const response = yield call(fetch, fetchCallBackupUrl, {
      method: 'POST',
      headers: {
